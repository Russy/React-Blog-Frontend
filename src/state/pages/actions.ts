...
export const GET_PAGES_REQUEST = (page: number | undefined) => ({ type: 'GET_PAGES_REQUEST', payload: page});
export const GET_PAGES_SUCCESS = (posts: any) => ({ type: 'GET_PAGES_SUCCESS', payload: posts});
...
export const SEARCH_PAGES_SUCCESS = (posts: any) => ({ type: 'SEARCH_PAGES_SUCCESS', payload: posts});
